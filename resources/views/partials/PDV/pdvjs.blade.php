...
<script src="{{asset('plugins/bootstrap-show-password/bootstrap-show-password.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('plugins/flot/jquery.flot.symbol.min.js')}}"></script>
<script type="text/javascript" src="{{asset('js/jquery-confirm.min.js')}}"></script>

<script type="text/javascript" src="{{asset('js/html2canvas.min.js?v=17')}}"></script>




<script type="text/javascript" src="{{asset('plugins/jquery-tag-it/js/tag-it.min.js')}}"></script>
<script type="text/javascript" src="{{asset('plugins/ckeditor/ckeditor.js')}}" charset="utf-8"></script>

<script type="text/javascript" src="{{asset('plugins/intro-js/minified/intro.min.js')}}"></script>
...
<script type="text/javascript" src="{{asset('plugins/bootstrap-wysihtml5/dist/bootstrap3-wysihtml5.all.min.js')}}"></script>
<script type="text/javascript" src="{{asset('plugins/bootstrap-wysihtml5/dist/locales/bootstrap-wysihtml5.es-ES.js')}}"></script> 

<script type="text/javascript" src="{{asset('plugins/parsley/dist/parsley.js')}}"></script>
<script type="text/javascript" src="{{asset('plugins/jquery-smart-wizard/src/js/jquery.smartWizard.js')}}"></script> 

<script type="text/javascript" src="{{asset('js/mikrowisp.js?v=6.168610539656')}}"></script>
...
<script>
    $("#data-registro-clients").DataTable();
